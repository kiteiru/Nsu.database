<template>
  <div>
    ...
    <div class="createForm">
      <el-form :model="form">
        <el-form-item label="Brigadier Full Name">
          <el-select-v2
              class="selectDropdown"
              v-model="form.worker.id"
              :options="this.allBrigadierOptions"
              placeholder="Select Brigadier"
          />
        </el-form-item>
...
import {brigadierIdParamOptions} from "@/data/parameters";
...
export default {
  ...
  setup() {
    const allBrigadierOptions = ref(brigadierIdParamOptions)
    return {allBrigadierOptions}
  }
}
</script>
